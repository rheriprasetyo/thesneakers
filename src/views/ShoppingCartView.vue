<template>
    ...
    <div class="container">
        ...
        <div class="breacrumb-section text-start">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8">
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="user-checkout text-start">
                                    <form>
                    ...
                    <div class="col-lg-4">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="proceed-checkout text-start">
                                    <ul>
                                    ...
                                    <!-- <router-link to="/success"> <a href="" class="list-group-item bg-dark text-white text-center w-100 remove-underline">I ALREADY PAID</a></router-link> -->
                                   
                                        <router-link to="/success"> <a href="#" class="list-group-item bg-dark text-white text-center w-100 p-3">I ALREADY PAID</a> </router-link>
